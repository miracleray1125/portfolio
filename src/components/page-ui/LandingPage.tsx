    ...
    >
      <div className="container grid grid-cols-12 gap-4 ">
        <div className="col-span-12 sm:col-span-8 flex flex-col justify-center">
          ...
          <p className="text-xs text-neutral-600 dark:text-neutral-200 text-center sm:text-left sm:text-4xl  ">
            {" "}
            Hello, I&apos;m{" "}
            <span className="text-red-500">Raymond Jefferson.</span>
